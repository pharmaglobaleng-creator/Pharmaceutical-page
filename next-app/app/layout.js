...
export const metadata = {
  ...
  description: 'Worldwide tablet tooling restoration, replacement parts, coatings, surface engineering, and compression support for pharmaceutical manufacturers.',
  ...
  openGraph: {
    ...
    url: '/',
    images: [{ url: '/assets/images/pharmaglobaleng-homepage.webp', alt: 'PharmaGlobalEng pharmaceutical tablet tooling and surface engineering homepage' }],
  },
  twitter: { card: 'summary_large_image', title: 'Pharmaceutical Tablet Tooling & Surface Engineering | PharmaGlobalEng', description: 'Worldwide pharmaceutical tablet tooling restoration, precision polishing, coatings, and surface engineering support.', images: ['/assets/images/pharmaglobaleng-homepage.webp'] },
