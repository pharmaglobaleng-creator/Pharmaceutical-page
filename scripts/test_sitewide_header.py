...
def main():
    ...
    try:
        with sync_playwright() as pw:
            ...
            page.locator('#services-menu').wait_for(state='visible');behavior.append('Homepage Services dropdown')
            page.set_viewport_size({'width':390,'height':844});page.locator('.menu-toggle').click()
            page.locator('.primary-nav').wait_for(state='visible');behavior.append('Homepage mobile menu')
            ...
            page.locator('.pc-mobile-nav>summary').click();page.locator('.pc-mobile-nav nav').wait_for(state='visible');behavior.append('Catalog mobile navigation')
